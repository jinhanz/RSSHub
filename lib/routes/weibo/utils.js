    ...
    formatExtended: (ctx, status, params = {}, picsPrefixes = [], isRetweet = false) => {
        ...
        if (showAuthorInDesc && isRetweet) {
            ...
            if (showAuthorAvatarInDesc) {
                usernameAndAvatar += `<img style="border-radius:50%!important; max-width:${sizeOfAuthorAvatar}!important; height:${sizeOfAuthorAvatar}!important" src="${status.user.profile_image_url}" ${
